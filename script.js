...
{
	idElement = "minutnik";
	document.getElementById(idElement).innerHTML = czasDoWydarzenia(2023, 06, 10, 20, 0, 0, 0);
	setInterval("document.getElementById(idElement).innerHTML = czasDoWydarzenia(2023, 06, 10, 20, 0, 0, 0)", 1000);
};
